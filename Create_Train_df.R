...
Changes_Between_CIP_DF <- as.data.frame(matrix(ncol= 5))
colnames(Changes_Between_CIP_DF) <- c("Sp_Fl","Nt_DP","P_f","F_p_n","SP_n")
...
colnames(Changes_Percent_Between_CIP_DF) <- c("Sp_Fl","Nt_DP","P_f","F_p_n","SP_n")
...
plot(Train_3_Nov_thru_Jan$Sp_Fl ~ Train_3_Nov_thru_Jan$Date_Time)
...
# x_1 = Percent Change of Specific Flux
